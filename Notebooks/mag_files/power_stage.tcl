...
# NMOS 1
box 0um 0 10um 10um
getcell mag_files/nmos_waffle_36x36
...
getcell mag_files/pmos_waffle_48x48
upsidedown
rotate -90
...
paint {metal3 metal4 metal5}
box 60um [expr {(($n_nmos-1)*$size + 2*($guard_offset_x + $guard_width) - 5)*2 - 32}]um [expr {($n_nmos-1)*$size + 2*($guard_offset_x + $guard_width) - 11}]um [expr {(($n_nmos-1)*$size + 2*($guard_offset_x + $guard_width) - 5)*2 + 48}]um
paint {metal3 metal4 metal5}
...
paint {metal3 metal4 metal5}
box [expr {($n_pmos-1)*$size + 2*($guard_offset_x + $guard_width) - 47}]um [expr {(($n_nmos-1)*$size + 2*($guard_offset_x + $guard_width) - 5)*2 + 18}]um [expr {($n_pmos-1)*$size + 2*($guard_offset_x + $guard_width) - 17}]um [expr {(($n_nmos-1)*$size + 2*($guard_offset_x + $guard_width) - 5)*2 + (($n_pmos-1)*$size + 2*($guard_offset_x + $guard_width) - 5) - 54}]um
paint {metal3 metal4 metal5}
...
paint {metal3 metal4 metal5}
box  [expr {($n_pmos-1)*$size + 2*($guard_offset_x + $guard_width) - 47}]um [expr {(($n_nmos-1)*$size + 2*($guard_offset_x + $guard_width) - 5)*2 + (($n_pmos-1)*$size + 2*($guard_offset_x + $guard_width) - 5) + 76}]um [expr {($n_pmos-1)*$size + 2*($guard_offset_x + $guard_width) - 17}]um [expr {(($n_nmos-1)*$size + 2*($guard_offset_x + $guard_width) - 5)*2 + (($n_pmos-1)*$size + 2*($guard_offset_x + $guard_width) - 5)*2 - 26}]um
paint {metal3 metal4 metal5}
...
box 60um [expr {(($n_nmos-1)*$size + 2*($guard_offset_x + $guard_width) - 5)*2 - 2}]um [expr {($n_nmos-1)*$size + 2*($guard_offset_x + $guard_width) - 65}]um [expr {(($n_nmos-1)*$size + 2*($guard_offset_x + $guard_width) - 5)*2 + 8}]um
...
label PW2 pwell
box 28.810um 29.440um 28.810um 29.440um 
label DNW1 nwell
